...
var Header = function (_a) {
    ...
    return (jsxRuntime.jsx("header", { children: jsxRuntime.jsxs("div", __assign({ className: "wrapper" }, { children: [jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("svg", __assign({ width: "32", height: "32", viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg" }, { children: jsxRuntime.jsxs("g", __assign({ fill: "none", fillRule: "evenodd" }, { children: [jsxRuntime.jsx("path", { d: "M10 0h12a10 10 0 0110 10v12a10 10 0 01-10 10H10A10 10 0 010 22V10A10 10 0 0110 0z", fill: "#FFF" }), jsxRuntime.jsx("path", { d: "M5.3 10.6l10.4 6v11.1l-10.4-6v-11zm11.4-6.2l9.7 5.5-9.7 5.6V4.4z", fill: "#555AB9" }), jsxRuntime.jsx("path", { d: "M27.2 10.6v11.2l-10.5 6V16.5l10.5-6zM15.7 4.4v11L6 10l9.7-5.5z", fill: "#91BAF8" })] })) })), jsxRuntime.jsx("h1", __assign({ className: "text-3xl font-bold underline bg-red-600 text-yellow-300" }, { children: "Hello world!" })), jsxRuntime.jsx("h2", __assign({ className: 'font-black bg-white rounded-lg shadow-lg' }, { children: "tailwind css\u30C6\u30B9\u30C8" }))] }), jsxRuntime.jsx("div", { children: user ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("span", __assign({ className: "welcome" }, { children: ["Welcome, ", jsxRuntime.jsx("b", { children: user.name }), "!"] })), jsxRuntime.jsx(Button, { size: "small", onClick: onLogout, label: "Log out" })] })) : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(Button, { size: "small", onClick: onLogin, label: "Log in" }), jsxRuntime.jsx(Button, { primary: true, size: "small", onClick: onCreateAccount, label: "Sign up" })] })) })] })) }));
};
