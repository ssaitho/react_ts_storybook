...
var Card = function (_a) {
    _a.user;
    return (jsxRuntime.jsxs("div", __assign({ className: 'w-full bg-white rounded-md shadow text-xs' }, { children: [jsxRuntime.jsx("div", __assign({ className: 'border-b border-gray-200 border-solid px-8 py-5 font-bold' }, { children: "header\u30C6\u30AD\u30B9\u30C8" })), jsxRuntime.jsx("div", __assign({ className: 'p-8' }, { children: "body\u30C6\u30AD\u30B9\u30C8" }))] })));
};
...
var Modal = function (_a) {
    _a.user;
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("button", __assign({ className: "block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800", type: "button", "data-modal-toggle": "popup-modal" }, { children: "Toggle modal" })), jsxRuntime.jsx("div", __assign({ id: "popup-modal", className: "hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full" }, { children: jsxRuntime.jsx("div", __assign({ className: "relative p-4 w-full max-w-md h-full md:h-auto" }, { children: jsxRuntime.jsxs("div", __assign({ className: "relative bg-white rounded-lg shadow dark:bg-gray-700" }, { children: [jsxRuntime.jsx("button", __assign({ type: "button", className: "absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white", "data-modal-toggle": "popup-modal" }, { children: jsxRuntime.jsx("svg", __assign({ className: "w-5 h-5", fill: "currentColor", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg" }, { children: jsxRuntime.jsx("path", { "fill-rule": "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", "clip-rule": "evenodd" }) })) })), jsxRuntime.jsxs("div", __assign({ className: "p-6 text-center" }, { children: [jsxRuntime.jsx("svg", __assign({ className: "mx-auto mb-4 w-14 h-14 text-gray-400 dark:text-gray-200", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, { children: jsxRuntime.jsx("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }) })), jsxRuntime.jsx("h3", __assign({ className: "mb-5 text-lg font-normal text-gray-500 dark:text-gray-400" }, { children: "Are you sure you want to delete this product?" })), jsxRuntime.jsx("button", __assign({ "data-modal-toggle": "popup-modal", type: "button", className: "text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" }, { children: "Yes, I'm sure" })), jsxRuntime.jsx("button", __assign({ "data-modal-toggle": "popup-modal", type: "button", className: "text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600" }, { children: "No, cancel" }))] }))] })) })) }))] }));
};
